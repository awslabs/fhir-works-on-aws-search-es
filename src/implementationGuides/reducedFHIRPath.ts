...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "expression$string$3", "symbols": [{"literal":"."}, {"literal":"w"}, {"literal":"h"}, {"literal":"e"}, {"literal":"r"}, {"literal":"e"}, {"literal":"("}, {"literal":"r"}, {"literal":"e"}, {"literal":"s"}, {"literal":"o"}, {"literal":"l"}, {"literal":"v"}, {"literal":"e"}, {"literal":"("}, {"literal":")"}, {"literal":" "}, {"literal":"i"}, {"literal":"s"}, {"literal":" "}], "postprocess": (d) => d.join('')},
    {"name": "expression", "symbols": ["path", "expression$string$3", "IDENTIFIER", {"literal":")"}], "postprocess": d => ({...d[0], condition: [d[0].path, 'resolve', d[2]]})},
